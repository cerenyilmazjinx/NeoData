...
#[derive(Debug)]
pub struct NeoDataProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoDataProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoData processing");
    
    let mut processor = NeoDataProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoDataProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoDataProcessor::new(false);
